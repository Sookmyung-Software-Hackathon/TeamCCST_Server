...
const models: TsoaRoute.Models = {
    "UserCreateResponseDto": {
        ...
        "properties": {
            ...
            "data": {"dataType":"nestedObjectLiteral","nestedProperties":{"accessToken":{"dataType":"string","required":true},"name":{"dataType":"string","required":true},"id":{"dataType":"double","required":true}},"required":true},
        },
    ...
    "RecipeResponseDto": {
        ...
        "properties": {
            ...
            "ingredient": {"dataType":"string","required":true},
    ...
    "EachRecipeResponseDto": {
        ...
        "properties": {
            "status": {"dataType":"double","required":true},
            "message": {"dataType":"string","required":true},
            "data": {"ref":"RecipeResponseDto","required":true},
        },
        "additionalProperties": true,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/recipe/:recipeId',
            ...
            async function RecipeController_getRecipeById(request: any, response: any, next: any) {
            const args = {
